...
public class ParticipEvent extends AsyncTask<String, Void, String> {
    private CustomInterface callback;
    private String response = "";
    public static final String URL = "http://projet_groupe2.hebfree.org/ParticipEvent.php";
    ...
    public ParticipEvent(CustomInterface callback){
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            cv.put("idUser",params[1]);
            cv.put("idEvent",params[2]);
            cv.put("nomEvent",params[3]);
