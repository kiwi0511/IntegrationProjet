...
public class SuppEvent extends AsyncTask<String, Void, String> {
    ...
    public interface CustomInterface{
        ...
        void showResultat2(String s);

    }

    public SuppEvent(CustomInterface callback){
